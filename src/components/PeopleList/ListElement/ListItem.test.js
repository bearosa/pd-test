...
test('renders modals', () => {
  ...
  //open info modal by clicking name
  fireEvent.click(getByTestId("list-element-name")); 

  let infoModalElement = screen.getByTestId("info-modal");

  expect(infoModalElement).toBeInTheDocument();

  //open delete modal by clicking delete
  fireEvent.click(getByTestId("info-modal-delete-button"))

  let deleteModalElement = screen.getByTestId("delete-modal");

  expect(infoModalElement).not.toBeInTheDocument();

  expect(deleteModalElement).toBeInTheDocument();

  //open info modal by clicking back
  fireEvent.click(getByTestId("delete-modal-back-button"));

  expect(deleteModalElement).not.toBeInTheDocument();

  infoModalElement = screen.getByTestId("info-modal");
  ...
  //open info modal by clicking avatar
  ...
  deleteModalElement = screen.getByTestId("delete-modal");
